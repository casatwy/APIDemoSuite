...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is APIDemoSuite
                   DESC

  s.homepage     = "https://github.com/casatwy/APIDemoSuite"
  ...
  s.source       = { :git => "https://github.com/casatwy/APIDemoSuite.git", :tag => s.version.to_s }
  ...
  s.source_files  = "APIDemoSuite/APIDemoSuite/**/*.{swift}"
  ...
  # s.ios.resource  = "APIDemoSuite/APIDemoSuite/APIDemoSuite.js"
